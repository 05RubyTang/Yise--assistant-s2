    ...
    groups: [
      {
        ...
        label: 'S2「狂欢怪谈」奇遇精灵',
        color: '#F48FB1',
        // desc 只在分组标题下展示一次，每条 entry 不再重复
        desc: '完成 S2 第五章赛季任务后开放（2026/6/12）· 各需捕捉 1 只奇异血脉的对应精灵',
        entries: [
          {
            fruit: '小丑公爵果实',
            spirit: '小丑公爵',
            attrs: ['恶系'],
            unlock: '捕捉 1 只奇异血脉的小丑公爵',
            usedInPlan: '刷异色方案',
          },
          {
            fruit: '小鼓象果实',
