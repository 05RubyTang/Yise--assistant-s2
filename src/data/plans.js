...
export const S1_PLANS = [
  ...
  // 获取方式：第六章赛季任务，捕捉2只污染血脉的对应精灵可获得
  {
    id: 'season_pinkstar',
    season: 'S1',
    category: 'seasonal',                   // 赛季奇遇类型标记（与 S2 保持一致）
    type: '粉粉星',
    icon: '⚡',
...
export const S2_PLANS = [
  ...
  },
  {
    ...
    spiritB: null,
    shinies: ['霹雳迪迪'],
    unlockA: 'S2 赛季任务，捕捉 2 只污染血脉的霹雳迪迪可获得',
    unlockB: null,
    sanctuary: '待游戏更新后补充',
    sanctuaryTip: '待游戏更新后补充',
  },
  {
    ...
    spiritB: null,
    shinies: ['狐脸擦擦'],
    unlockA: 'S2 赛季任务，捕捉 2 只污染血脉的狐脸擦擦可获得',
    unlockB: null,
    sanctuary: '待游戏更新后补充',
    sanctuaryTip: '待游戏更新后补充',
  },
  ...
  },
  {
    ...
    spiritB: null,
    shinies: ['咕咚帽帽'],
    unlockA: 'S2 赛季任务，捕捉 2 只污染血脉的咕咚帽帽可获得',
    unlockB: null,
    sanctuary: '待游戏更新后补充',
    sanctuaryTip: '待游戏更新后补充',
  },
  ...
  },
  {
    ...
    spiritB: null,
    shinies: ['巨鼓象'],
    unlockA: 'S2 赛季任务，捕捉 2 只污染血脉的巨鼓象可获得',
    unlockB: null,
    sanctuary: '待游戏更新后补充',
    sanctuaryTip: '待游戏更新后补充',
  },
